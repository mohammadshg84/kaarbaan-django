...
SECRET_KEY = 'django-insecure-nunte*i7g_k*&8ae#2k36!t1kk467avehaj=82#98#8_i%#6fs'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'app.context_processors.user_is_manager',  # این خط را اضافه کنید
...
CKEDITOR_CONFIGS = {
    'default': {
        'toolbar': [
            ...
            {'name': 'insert', 'items': ['Image', 'Table', 'HorizontalRule', 'SpecialChar']},  # Image باید باشه
            '/',
            {'name': 'styles', 'items': ['Styles', 'Format', 'Font', 'FontSize']},
            {'name': 'colors', 'items': ['TextColor', 'BGColor']},
            {'name': 'tools', 'items': ['Maximize', 'ShowBlocks']},
        ],
        'extraPlugins': 'uploadimage',  # فعال کردن پلاگین آپلود تصویر
        'language': 'fa',
        'width': '100%',
        'height': 300,
